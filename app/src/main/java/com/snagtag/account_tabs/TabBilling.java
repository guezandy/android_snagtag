 ...
 *
 */
public class TabBilling extends Fragment {
    /** (non-Javadoc)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new ParseService(getActivity().getApplicationContext()).getBillingPerUser(getActivity().getApplicationContext(), new IParseCallback<List<ShippingModel>>() {
            @Override
